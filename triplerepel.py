...
logHandler = logging.FileHandler('triple_relax.log')
...
if __name__=='__main__':
    ...
    while des.minmax[1] > F_LIMIT and des.mean > F_LIMIT/2.5:
        ...
        force_mag = [quadrature(xy) for xy in np.concatenate(column_force)]
        ...
        np.save('repel_result.npy', column)
        step += 1 